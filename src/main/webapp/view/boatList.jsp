...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<%=basePath%>/index" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 我的站点</a> <a href="#" class="current">帆船信息</a> </div>
    <h1>帆船</h1>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
              <c:forEach items="${boatInfoList}" var="boatInfo">
                <tr>
                  <td>${boatInfo.count}</td>
                  <td>${boatInfo.boatName}</td>
                  <td>${boatInfo.destId}</td>
                  <td>${boatInfo.botaType}</td>
